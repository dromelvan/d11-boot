...
public class IncidentEventHelper {
     ...
     */
    private final Map<Integer, List<IncidentEvent>> typeMap = new ConcurrentHashMap<>();

    /**
     * Maps player ids to maps of type values to lists of incident events.
     */
    private final Map<Long, Map<Integer, List<IncidentEvent>>> playerMap = new ConcurrentHashMap<>();
