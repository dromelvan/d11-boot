...
@Slf4j
@Transactional
public class ApiRepositoryService<T extends D11Entity, U, V extends D11EntityRepository<T>> extends ApiService {
    ...
    public ApiRepositoryService(final V jpaRepository) {
