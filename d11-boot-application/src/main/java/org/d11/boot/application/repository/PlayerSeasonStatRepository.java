...
public interface PlayerSeasonStatRepository extends D11EntityRepository<PlayerSeasonStat> {
    ...
    /**
     * Gets player season stats for a specific team and a specific season ordered by player position sort order and
     * points descending.
     *
     ...
     */
    List<PlayerSeasonStat> findByTeamIdAndSeasonIdOrderByPositionSortOrderAscPointsDesc(
            @Param("teamId") Long teamId,
            @Param("seasonId") Long seasonId
    );

    /**
     * Gets player season stats for a specific D11 team and a specific season ordered by player position sort order and
     * points descending.
     *
     ...
     * @return Player season stats for the team and the season.
     */
    List<PlayerSeasonStat> findByD11TeamIdAndSeasonIdOrderByPositionSortOrderAscPointsDesc(
