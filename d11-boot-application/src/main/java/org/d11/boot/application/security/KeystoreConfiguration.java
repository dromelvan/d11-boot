...
public class KeystoreConfiguration {
     ...
     */
    @Value("${d11.security.keystore.location}")
    ...
    public KeyStore keyStore() {
        ...
        try {
            ...
            inputStream = Thread.currentThread().getContextClassLoader().getResourceAsStream(this.location);
            ...
            try {
                ...
                log.error("Could not close keystore input stream.", e);
            }
        }
    }
